...
export const tools: Tool[] = [
  ...
  { name: 'Astro', category: 'framework', logo: '/logos/astro.svg', description: 'A web framework for building fast, content-focused websites with any UI framework.' },
...
const rawEdges = [
  ...
  { source: 'Astro', target: 'Angular', label: 'With @analogjs/astro-angular' },
  { source: 'Astro', target: 'Vue.js', label: 'supports' },
  { source: 'Astro', target: 'Svelte', label: 'supports' },
  { source: 'Astro', target: 'Preact', label: 'supports' },
  { source: 'Astro', target: 'React', label: 'supports' },
  ...
  { source: 'ts-node', target: 'tsc', label: 'Use' },
  { source: 'ts-node', target: 'SWC', label: 'Use' },
  { source: 'ts-node', target: 'Bun', label: 'Use' },
  { source: 'Turbopack', target: 'SWC', label: 'Use' },
  { source: 'Rspack', target: 'SWC', label: 'Use' },
  { source: 'Farm', target: 'SWC', label: 'Use' },
  { source: 'Bun', target: 'SWC', label: 'Use' },
  { source: 'esbuild', target: 'SWC', label: '' },
  { source: 'Parcel', target: 'SWC', label: 'Use' },
