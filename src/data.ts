...
export const tools: Tool[] = [
  { name: 'TanStack Start', category: 'metaframework', logo: '/logos/tanstack-start.png' },
  { name: 'SolidStart', category: 'metaframework', logo: '/logos/solid-start.svg' },
  { name: 'SvelteKit', category: 'metaframework', logo: '/logos/sveltekit.svg' },
  { name: 'Qwik City', category: 'metaframework', logo: '/logos/qwik-city.png' },
  ...
  { name: 'Mitosis', category: 'framework', logo: '/logos/mitosis.png' },
  { name: 'Gatsby', category: 'framework', logo: '/logos/gatsby.svg' },
  { name: 'Docusaurus', category: 'framework', logo: '/logos/docusaurus.svg' },
  { name: 'Nitro', category: 'framework', logo: '/logos/nitro.png' },
  { name: 'UnJS libs', category: 'framework', logo: '/logos/unjs.png' },
  ...
  { name: 'Qwik', category: 'library', logo: '/logos/qwik.png' },
  { name: 'Solid.js', category: 'library', logo: '/logos/solid.png' },
  { name: 'LIT', category: 'library', logo: '/logos/lit.svg' },
  { name: 'Alpine', category: 'library', logo: '/logos/alpine.svg' },
  { name: 'Fresh', category: 'framework', logo: '/logos/fresh.png' },
  ...
  { name: 'Turbopack', category: 'bundler', logo: '/logos/turbopack.png' },
  { name: 'Webpack', category: 'bundler', logo: '/logos/webpack.svg' },
  { name: 'Rspack', category: 'bundler', logo: '/logos/rspack.png' },
  { name: 'Farm', category: 'bundler', logo: '/logos/farm.png' },
  ...
  { name: 'Biome', category: 'linter', logo: '/logos/biome.png' },
  { name: 'ESLint', category: 'linter', logo: '/logos/eslint.svg' },
  { name: 'Oxlint', category: 'linter', logo: '/logos/oxlint.png' },
  ...
  { name: 'ts-node', category: 'compiler', logo: '/logos/tsnode.svg' },
  { name: 'Acorn', category: 'parser', logo: '/logos/acorn.svg' },
  { name: 'OXC', category: 'compiler', logo: '/logos/oxc.png' },
